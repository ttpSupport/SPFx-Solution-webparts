    ...
    return (
		<div className="container d-flex justify-content-between">
			<div className="breadcrumb">
				{this.state.breadcrumbItems.map((item, id) => 
					<a href={item.href} className={item.isCurrentItem && "active"} key={item.key}>{item.text}
						{id < this.state.breadcrumbItems.length - 1 && <i className="fa fa-angle-right"></i>}
					</a>
				)}
			</div>
			<div className="back-to-dept">
